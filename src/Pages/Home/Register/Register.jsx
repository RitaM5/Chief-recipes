...
const Register = () => {
    ...
    return (
        <div className='my-16 my-container'>
            <div className="card w-96 mx-auto bg-blue-200">
                <form className="card-body" onSubmit={handleRegister}>
                    <input type="text" name="name" placeholder="name" className="input w-full max-w-xs" required />
                    <input type="email" name="email" placeholder="email" className="input w-full max-w-xs" required />
                    <input type="password" name="password" placeholder="password" className="input w-full max-w-xs" required />
                    <input type="text" name="photo" placeholder="photo url" className="input w-full max-w-xs" required />
